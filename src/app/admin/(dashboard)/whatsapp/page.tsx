    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-ink-soft">
          Conversations from the site&apos;s WhatsApp button. The bot answers automatically until it hands a
          conversation off to you — reply from a thread to take over.
        </p>
      </div>
